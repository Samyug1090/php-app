...
<head>
    ...
    <title>Equiment | Rapti Medical and Swasthya Clinic</title>
...
<body>
    ...
    <section class="courses">
        <h2>Our State-of-the-Art Equipments</h2>
        <div class="container courses__container">
            <article class="course">
                ...
                <div class="course__info">
                    <h4>CBS-300</h4>
                    <p>
                    It is a tool used for measuring sodium, potassium, and chloride levels in blood, serum, or plasma.
                    </p>
                </div>
            </article>
            <article class="course">
                ...
                <div class="course__info">
                    <h4>Hot Air Oven</h4>
                    <p>
                        it is a tool used to sterilise materials such as glassware, chemicals, and sealed containers.
                    </p>
                </div>
            </article>
            <article class="course">
                ...
                <div class="course__info">
                    <h4>Centrifuge</h4>
                    <p>
                        It is a tool used to separate fluids based on density.
                    </p>
                </div>
            </article>
            <article class="course">
                ...
                <div class="course__info">
                    <h4>Coagulation Analyzer</h4>
                    <p>
                        it is a tool used for Aptt, Coagulation Factor and .d dimer
                    </p>
                </div>
            </article>
            ...
            <article class="course">
                ...
                <div class="course__info">
                    <h4>Laminar Air Flow</h4>
                    <p>
                        It is a tool used for aseptic transfer of microbial culture.
                    </p>
                </div>
            </article>
            <article class="course">
                ...
                <div class="course__info">
                    <h4>Toso @A-39</h4>
                    <p>
                        It is a tool used for testing Thyroid.
                    </p>
                </div>
            </article>
            <article class="course">
                ...
                <div class="course__info">
                    <h4>Microscope</h4>
                    <p>
                        It is a tool used to observe small objects, even cells
                    </p>
                </div>
            </article>
            <article class="course">
                ...
                <div class="course__info">
                    <h4>Digital Incubator</h4>
                    <p>
                        It is a tool used to grow and maintain microbiological or cell cultures
                    </p>
                </div>
            </article>
            <article class="course">
                ...
                <div class="course__info">
                    <h4>Maglumi 600</h4>
                    <p>
                        It is a tool used for Immuno analyzer for conducting thyroid.
                    </p>
                    <p>Vitamin, Anti TPO test</p>
                </div>
            </article>
            <article class="course">
                <div class="course__image">
                ...
                <div class="course__info">
                    <h4>Automatic Hematology Analyzer</h4>
                    <p>
                        It is a tool used for white blood cell counts, complete blood counts, reticulocyte analysis, and coagulation
                        tests
                    </p>
                </div>
            </article>
            <article class="course">
                ...
                <div class="course__info">
                    <h4>Protein Analyzer</h4>
                    <p>
                       It is a tool used for C-reactive protein (CRP) and rheumatoid arthritis (RA) analysis
                    </p>
                </div>
            </article>
            <article class="course">
                ...
                <div class="course__info">
                    <h4>Electrolyte</h4>
                    <p>
                        It is a tool used for potassium analysis
                    </p>
                </div>
            </article>
            <article class="course">
                ...
                <div class="course__info">
                    <h4>Biochem Analyzer</h4>
                    <p>
                        It is a tool used for biochemical test
                    </p>
                </div>
            </article>
            <article class="course">
                ...
                <div class="course__info">
                    ...
                    <p>
                        It is a medical test used to measure the electrical activity of the brain.
                    </p>
                    <p>This machinne is used in Neuro-Psychiatry case.</p>
                </div>
            </article>
            <article class="course">
                <div class="course__image">
            ...
            <article class="course">
                ...
                <div class="course__info">
                    ...
                    <p>
                        It is a tool uses high frequency sound waves to make pictures of your heart.
                    </p>
                    <p>The test is also called echocardiography or diagnostic cardiac ultrasound.</p>
                </div>
            </article>
        </div>
    </section>
